...
> ⚠️ For **defensive security testing and product development only**. Dashboard demo data is simulated; the analysis engine, GPT-5.6 reasoning, Prompt Shield, agent policy enforcement and audit persistence are real.
