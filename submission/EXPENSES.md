...
|---|---|---:|---|
| Marketing & customer acquisition | [e.g. LinkedIn ads / none] | $0.00 | [receipt / "n/a"] |
| Cloud infrastructure | Google Cloud (Vertex AI, Cloud Run, Secret Manager) | | GCP billing export |
| Payments | Stripe fees | | Stripe dashboard |
| Tooling | Domain, email, misc | | receipts |
| Contractors | [none / name + role] | | invoices |
| **Total spend** | | **$0.00** | |
